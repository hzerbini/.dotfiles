...
globalkeys = gears.table.join(
	...
	end, { description = "show clients open in the current tab", group = "client" }),
	awful.key({ modkey, "Shift" }, "w", function()
		awful.spawn.with_shell("rofi -show window")
	end, { description = "show clients open", group = "awesome" }),
	...
	awful.key({ modkey, "Control" }, "s", function()
		awful.spawn.with_shell(terminal .. " -e /home/zerbini/Scripts/ff.sh")
	end, { description = "open tmux session creator (saved ones)", group = "launcher" }),
	awful.key({ modkey, "Shift" }, "s", function()
		awful.spawn.with_shell(terminal .. " -e /home/zerbini/Scripts/fo.sh")
	end, { description = "open tmux session creator", group = "launcher" }),
	...
	awful.key({ modkey, "Shift" }, "p", function()
		awful.spawn.with_shell(terminal .. " --class password-fzf -e /home/zerbini/Scripts/fzf-pass-info")
	end, { description = "open password info fzf", group = "launcher" }),
	...
	awful.key({ modkey }, "a", function()
		...
		grabber = awful.keygrabber.run(function(_, key, event)
			...
			elseif key == "t" then
				awful.spawn.raise_or_spawn("clickup")
			elseif key == "h" then
				awful.spawn.spawn(terminal .. " --class htop -e htop")
			elseif key == "i" then
				awful.spawn.raise_or_spawn("gimp-2.10")
			elseif key == "k" then
				awful.spawn.raise_or_spawn("keepassxc")
			elseif key == "m" then
				awful.spawn.raise_or_spawn("studio-3t")
			elseif key == "o" then
	...
	end, { description = "open application", group = "launcher" }),
	...
	end, { description = "open secondary application", group = "launcher" }),
	...
	awful.key({}, "XF86AudioRaiseVolume", function()
		volumewidget:inc(5)
	end, { description = "raise audio volume", group = "sound" }),
	awful.key({}, "XF86AudioLowerVolume", function()
		volumewidget:dec(5)
	end, { description = "lower audio volume", group = "sound" }),
	awful.key({}, "XF86AudioMute", function()
		volumewidget:toggle()
	end, { description = "toggle volume mute", group = "sound" }),
	...
	awful.key({}, "XF86MonBrightnessUp", function()
		brightnesswidget:inc()
	end, { description = "increase brighntess", group = "brigtness" }),
	awful.key({}, "XF86MonBrightnessDown", function()
		brightnesswidget:dec()
	end, { description = "decrease brighntess", group = "brigtness" }),

	-- Printscreen
	awful.key({ modkey }, "Print", function()
		awful.util.spawn("flameshot gui --region 1920x1080+1366+30")
	end, { description = "gui-print (region selected)", group = "printscreen" }),
	awful.key({ modkey, "Shift" }, "Print", function()
		awful.util.spawn("flameshot gui")
	end, { description = "gui-print", group = "printscreen" }),
	awful.key({}, "Print", function()
		awful.util.spawn("flameshot full -p /home/zerbini/Imagens/Screenshots --region 1920x1080+1366+30")
	end, { description = "print (region-selected save)", group = "printscreen" }),
	awful.key({ "Shift" }, "Print", function()
		awful.util.spawn("flameshot full --region 1920x1100+1366+0 -p /home/zerbini/Imagens/Screenshots")
	end, { description = "print (save)", group = "printscreen" })
)
...
clientkeys = gears.table.join(
	...
	end, { description = "unminimize all clients in the current tag", group = "client" }),
	...
	end, { description = "unmaximize all clients in the current tag", group = "client" }),
